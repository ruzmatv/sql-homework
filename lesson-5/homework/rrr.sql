...
select 
iif(stockQuantity>100,'true' , 'false') as newTable from Products_Discounted
...
select 
iif(Price>1000,'Qimmat','Hamyonbop')as newTable from Products
